...
(def articles
  [{:name "Humble Beginnings: the VIC-20", :id "humble-beginnings-the-vic-20",
   ...
   {:name "Developer experience in 1987 with C64 vs modern tools", :date "2021-12-18", 
   ...
   {:name "Excel-revolution at Steel Factory in 1989" :date "2022-05-29", :updated "2024-12-25"
    :id "ovako-excel" :id-long "excel-revolution-at-steel-factory-in-1989", 
