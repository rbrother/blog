...
(def articles
  [{:name "Humble Beginnings: the VIC-20", :id "humble-beginnings-the-vic-20", :date "2019-02-15",
   ...
   {:name "Blast from my Commodore 64 Past", :id "ruletti-c64", :id-long "blast-from-my-commodore-64-past",
   ...
   {:name "Developer experience in 1987 with C64 vs modern tools", :date "2021-12-18", :id "ruletti-developer-experience"
    :id-long "developer-experience-in-1987-with-c64-vs-modern-tools", :tags #{"Computers" "Commodore" "Programming" "Development Tools"}}
